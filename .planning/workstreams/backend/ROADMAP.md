...
- [x] 03-02-PLAN.md — Auth + RBAC + Infrastructure: JWT auth, users table, role dependencies, deps install (RISK-07)
...
- [x] 03-09-PLAN.md — Export + Dockerfile + Inspection Fixes: templates copy, GeoJSON/CSV/MinIO, structure_id verification (RISK-08, DATA-05)
